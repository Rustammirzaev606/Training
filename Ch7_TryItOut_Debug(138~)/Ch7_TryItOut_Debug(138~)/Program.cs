...
namespace Ch7_TryItOut_Debug_138__
{
    class Program
    {
        ...
        static int Maxima(int[] integers, out int[] indices)
        {
            ...
            {
                Debug.WriteLine(string.Format($"Now looking at element index {i}."));
            ...
            Trace.WriteLine(string.Format($"Maximum valuu {maxVal} found, with {count} occurrences."));
